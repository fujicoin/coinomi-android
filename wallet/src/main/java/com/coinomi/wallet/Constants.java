...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(FujicoinMain.get(),     new ServerAddress("electrumx1.fujicoin.org", 50001), //SSL:50002
                                                    new ServerAddress("electrumx2.fujicoin.org", 50001), //SSL:50002
                                                    new ServerAddress("electrumx3.fujicoin.org", 50001)) //SSL:50002
    );
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        COINS_ICONS.put(CoinID.IXCOIN_MAIN.getCoinType(), R.drawable.fujicoin);
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.URO_MAIN.getCoinType(), "https://chainz.cryptoid.info/uro/tx.dws?%s");
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.FUJICOIN_MAIN.getCoinType(), "http://explorer.fujicoin.org/tx/%s");
    }
